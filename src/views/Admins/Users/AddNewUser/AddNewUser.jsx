...
import useViewModel from "./AddNewUserViewModel";
...
export default function AddNewUser() {
    ...
    return (
        <div>
            ...
            <Link to="/admins/dashboard/users">
            ...
            <form className="flex flex-col md:w-1/2 w-full gap-4 mt-4" onSubmit={handleSubmit}>
                ...
                <div className="flex justify-center w-full flex-col gap-4">
                    <label htmlFor="name" className='font-bold'>Birth date</label>
                    <input
                        className="w-full p-2 mb-4 bg-white rounded-xl text-slate-700 outline-kPrimaryColor"
                        type="date"
                        name="birthDate"
                ...
                <div className="flex justify-center w-full flex-col gap-4">
                    <label htmlFor="phone" className='font-bold'>Parent Phone</label>
                    <input
                        className="w-full p-2 mb-4 bg-white rounded-xl text-slate-700 outline-kPrimaryColor"
                        type="text"
                        name="parentPhone"
